...
<head>
    ...
    <style>
        ...
        .page-header h2 { font-size: 32px; font-weight: 900; color: var(--coral); margin: 0 0 30px; text-transform: lowercase; }
            ...
            <table>
                ...
                <tbody>
                    <?php if ($res_low_stock->num_rows > 0): ?>
                        ...
                        <?php 
                            // BAGO: Checker kung 0 na talaga yung stock (ginamitan ng floatval para sa materials)
