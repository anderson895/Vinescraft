...
if (isset($_POST['save_update'])) {
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        $sql = "UPDATE products SET name='$name', category='$category', description='$description', price='$price', stock='$new_stock', image='$image' WHERE product_id=$id";
    } else {
        $sql = "UPDATE products SET name='$name', category='$category', description='$description', price='$price', stock='$new_stock' WHERE product_id=$id";
    }
...
if (isset($_POST['add_product'])) {
    ...
    $sql = "INSERT INTO products (name, description, price, stock, image) VALUES ('$name', '$description', 'category', '$price', '$stock', '$image')";
