...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_email->num_rows > 0) {
        ...
        // Maganda na i-hash natin agad yung password para safe sa database
        $hashed_password = password_hash($password, PASSWORD_DEFAULT);

        // SQL query para mag insert ng data sa users table
        $sql = "INSERT INTO users (name, email, mobile_no, password, address, role) 
                VALUES ('$name', '$email', '$mobile_no', '$hashed_password', '$address', 'customer')";
    ...
    <div class="register-card">
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <textarea name="address" placeholder="Bagtas, Tanza, Cavite" required></textarea>
            </div>
