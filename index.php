...
<head>
    ...
    <title>Chub's Handicrafts | Home</title>
    <style>
        ...
        .status-toast {
            background: white;
            border-left: 5px solid #2ed573; /* Green indication */
            padding: 15px 25px;
            border-radius: 12px;
        ...
        .toast-content { font-size: 13px; font-weight: 700; color: var(--text-dark); flex-grow: 1; line-height: 1.4; }
        .toast-close { cursor: pointer; font-size: 18px; color: #aaa; font-weight: bold; }
        .toast-close:hover { color: var(--coral); }
        ...
        .section-title h2 { font-size: 32px; font-weight: 900; margin-bottom: 5px; }
        ...
        .story-content h2 { font-size: 36px; font-weight: 900; color: var(--coral); margin-bottom: 20px; }
        ...
        .location-details h2 { font-size: 32px; font-weight: 900; color: var(--coral); margin-bottom: 20px; }
...
.btn-welcome {
    ...
    font-size: 12px;
    text-transform: uppercase;
    box-shadow: 0 10px 20px rgba(241, 137, 115, 0.3);
    transition: 0.3s;
}
.btn-welcome:hover {
    background: #e07661;
...
<section class="hero">
    <div class="hero-copy">
        ...
        <h1><span>Fluffy blooms</span>Handmade with <em>love</em></h1>
        <p class="hero-tagline">Flowers that stay soft, sweet, and unforgettable long after the moment passes.</p>
        <p class="hero-subcopy">Discover fuzzy wire bouquets, custom gifts, and keepsake pieces crafted with a personal touch from Dasmariñas.</p>
...
<div class="section-title">
    ...
    <p>Hand-crafted arrangements delivered in friendly Dasmariñas. Pick the perfect gesture for your loved ones now.</p>
</div>
...
<section class="story-preview">
    <div class="story-img-container">
        <img src="img/team.jpg" alt="Chub's Team">
    </div>
    <div class="story-content">
        <h2>The story behind the blooms</h2>
        <p>
            Chub's Handicrafts began with a fascination for nature and permanence. From the heart of Dasmariñas, we transform fuzzy wire into timeless art, ensuring that every gift is a lasting memory, not just a temporary gesture.
        </p>
...
<section class="location-section">
    <div class="location-details">
        ...
        <p>📍 <strong>Location:</strong> 72 Isidro Mangubat St., Zone 4, Dasmariñas, Cavite</p>
    ...
    <div class="location-map">
        <iframe width="100%" height="400" frameborder="0" style="border:0" src="https://maps.google.com/maps?q=3-38,+I.+Mangubat+St,+Dasmariñas,+Cavite&t=&z=16&ie=UTF8&iwloc=&output=embed" allowfullscreen></iframe>
    </div>
</section>

<footer>
    <p>© 2026 Chub's Handicrafts | Handcrafted in Dasmariñas</p>
</footer>

<!-- WELCOME POPUP MODAL -->
<div class="welcome-overlay" id="welcomeOverlay" onclick="closeWelcomePopup()">
    <div class="welcome-modal" id="welcomeModal" onclick="event.stopPropagation()">
        <button class="close-welcome" onclick="closeWelcomePopup()">✕</button>
        <div class="welcome-img"></div>
        <div class="welcome-content">
            <h2>Welcome to Chub's Handicrafts!</h2>
            <p>Discover our beautiful, handcrafted fuzzy wire blooms that last forever. Perfect for gifts, keepsakes, and special moments.</p>
            <a href="shop.php" class="btn-welcome">Explore Shop</a>
        </div>
    </div>
</div>
