...
// FETCH REVIEWS: Kukunin lahat ng reviews regardless kung sino ang naka-login
...
<head>
    ...
    <title><?= htmlspecialchars($product['name']) ?> | Chub's Handicrafts</title>
    <style>
        ...
        /* Tinanggal na ang text-transform: lowercase dito */
        .content-wrapper h1 { font-size: 42px; font-weight: 900; color: var(--coral); margin: 0 0 5px 0; }
